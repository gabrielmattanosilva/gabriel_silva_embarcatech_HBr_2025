...
| Projeto | Descrição |
|---------|-----------|
| [Segurança Sênior](./projetos/seguranca_senior/) | Sistema de envio de mensagens de alerta via Whatsapp |
| [Galton Board Digital](./projetos/galton_board/) | Simulação de eventos aleatórios com visualização em display OLED e histograma |
| [Sintetizador de Som](./projetos/synth_dma_pwm/) | Geração de sons com botões e buzzer |
